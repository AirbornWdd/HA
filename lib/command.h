/*
 * Kroute configuration command interface routine
...
#ifndef _KROUTE_COMMAND_H
#define _KROUTE_COMMAND_H
...
enum node_type 
{
  ...
  KROUTE_NODE,			/* kroute connection node. */
...
"(neighbor|interface|area|lsa|kroute|config|dbex|spf|route|lsdb|redistribute|hook|asbr|prefix|abr)"
#define ISIS_STR "IS-IS information\n"
#define AREA_TAG_STR "[area tag]\n"

#define CONF_BACKUP_EXT ".sav"

#define HA_STR "HA information\n"
