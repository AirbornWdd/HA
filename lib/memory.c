...
DEFUN (show_memory_ha,
       ...
       "HA memory\n")
{
  show_memory_vty (vty, memory_list_ha);
  return CMD_SUCCESS;
}
...
memory_init (void)
{
  ...
  install_element (RESTRICTED_NODE, &show_memory_ha_cmd);

  install_element (VIEW_NODE, &show_memory_cmd);
  install_element (VIEW_NODE, &show_memory_all_cmd);
  install_element (VIEW_NODE, &show_memory_lib_cmd);
  install_element (VIEW_NODE, &show_memory_ha_cmd);

  install_element (ENABLE_NODE, &show_memory_cmd);
  install_element (ENABLE_NODE, &show_memory_all_cmd);
  install_element (ENABLE_NODE, &show_memory_lib_cmd);
  install_element (ENABLE_NODE, &show_memory_ha_cmd);
}

